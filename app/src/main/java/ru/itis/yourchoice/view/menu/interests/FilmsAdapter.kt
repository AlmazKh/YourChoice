...
class FilmsAdapter(
//    private val subcategoryLambda: (Subcategory) -> Unit
) : ListAdapter<Subcategory, SubcategoryViewHolder>(SubcategoryDiffCallback()) {
...
//            subcategoryLambda.invoke(getItem(p1))
//        }
    }
}
